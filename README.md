...
Simple SSH tunnelling for Go programs.

## Installation

```bash
go get -u -v github.com/thiagozs/sshtunnel
```

Get the packets with `govendor sync`:

```bash
cd $GOPATH/src/github.com/thiagozs/sshtunnel
govendor sync
```
...
tunnel := sshtunnel.NewSSHTunnel(
   ...
   // if not specified.
   "ec2-user@jumpbox.us-east-1.yourdomain.com",
   ...
   "xyz.us-east-1.redshift.amazonaws.com:5439",
)
